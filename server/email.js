// Aviso por email cuando llega una consulta nueva desde el formulario del sitio. Usa
// Resend (resend.com) - a diferencia de Mongo o Cloudinary, esto es OPCIONAL: si falta
// RESEND_API_KEY o NOTIFY_EMAIL, el sitio sigue funcionando normal, simplemente no manda
// el aviso (la consulta ya quedó guardada en la base de todas formas, visible en el
// panel, pestaña Consultas). El remitente vive en el dominio de FrontyBack (no en el del
// cliente), así no hace falta verificar un dominio nuevo por cada sitio que se suma.
...
// vacíos (ej: celular opcional que no completaron) para no dejar renglones en blanco.
